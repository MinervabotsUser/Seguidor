...
class ComplementaryFilter
{
  public:
    ...
    void Run(float driftValue, float noiseValue, float ratio)
    {
      unsigned long t = micros();
      dt = (t - lastRun) * 0.000001;
      lastRun = t;
      value = ratio * (value + driftValue * dt) + (1 - ratio) * noiseValue;
    }
};
...
class KalmanFilterRotation
{
  public:
    ...
    void init(float R, float Q1, float Q2, float estadoInicial)
    {
      this->R[0][0]= R;
      this->R[1][1] = R;
      this->Q[0][0] = Q1;
